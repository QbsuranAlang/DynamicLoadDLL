    ...
    class dld
    {
        ...
        public void LoadDll(string lpFileName)
        {
            ...
            if (hModule == IntPtr.Zero)
                throw (new Exception(" LoadLibrary沒有找到 : " + lpFileName + " ."));
        }
        ...
        { // 若函數庫模塊的句柄為空，則拋出異常 
            ...
            if (farProc == IntPtr.Zero)
                throw (new Exception(" GetProcAddress沒有找到 : " + lpProcName + " 這個函數的入口點 "));
        }
        ///  
        /// 獲得函數指針 
        ///  
        ...
        { // 取得函數庫模塊的句柄 
            ...
            // 若函數指針，則拋出異常 
            if (farProc == IntPtr.Zero)
                throw (new Exception("檔案 : " + Path.GetFileName(lpFileName) + " GetProcAddress沒有找到 : " + lpProcName + " 這個函數的入口點 "));
        }
